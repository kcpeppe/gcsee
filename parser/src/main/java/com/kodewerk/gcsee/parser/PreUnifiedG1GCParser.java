...
import com.kodewerk.gcsee.event.g1gc.G1ConcurrentCleanup;
...
import com.kodewerk.gcsee.event.g1gc.G1ConcurrentStringDeduplication;
...
import com.kodewerk.gcsee.event.g1gc.G1Trap;
...
public class PreUnifiedG1GCParser extends PreUnifiedGCLogParser implements G1GCPatterns {
    ...
    public void endOfFile(GCLogTrace trace, String line) {
        super.publish(ChannelName.G1GC_PARSER_OUTBOX, new JVMTermination(getClock(),diary.getEstimatedStartTime()));
    }
    ...
    private void log(String line) {
        ...
        GCSee.LOG_DEBUG_MESSAGE(() -> "Missed: " + line);
